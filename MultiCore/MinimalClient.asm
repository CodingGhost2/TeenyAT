; MinimalClient.asm - Intelligent wandering with enemy detection and pursuit.
; Implements vision scanning and adaptive movement based on nearby threats.
...
!no_target_found
    ; --- NO TARGET, WANDER INTELLIGENTLY ---
    ; Use a simple pseudo-random pattern based on client X position
    lod rA, [CLIENT_X]
